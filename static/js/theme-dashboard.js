...
(function () {
    ...
    var THEMES = {
        ...
        dracula: {
            label: 'Dracula',
            desc: 'Purple + pink on charcoal. Cult classic.',
            swatch: ['#bd93f9', '#ff79c6', '#50fa7b']
        },
        catppuccin: {
            label: 'Catppuccin',
            desc: 'Soft pastels on warm black. Easy on the eyes.',
            swatch: ['#89b4fa', '#fab387', '#cba6f7']
        }
    };
    ...
    function buildPanel() {
        ...
        document.addEventListener('keydown', function (e) {
            ...
            switch (e.key) {
                case '[':
                    nudge('lt.rain.speed', -0.1, 0.2, 3, '1', 2);
                    e.preventDefault();
                    break;
                case ']':
                    nudge('lt.rain.speed', 0.1, 0.2, 3, '1', 2);
                ...
                case '-':
                case '_':
                    nudge('lt.rain.opacity', -0.02, 0, 0.5, '0.1', 3);
                    e.preventDefault();
                    break;
                case '=':
                case '+':
